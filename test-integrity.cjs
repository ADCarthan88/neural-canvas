...
// 3. Backend Server Test Function
...
try {
  ...
  logTest('Root route handler', hasRootRoute, hasRootRoute ? 'Available' : 'Missing');
...
async function runBackendTests() {
  console.log('\n🌐 Testing Backend Endpoints (if server is running)...');
  ...
  console.log('   • Start both: npm run dev');
}
